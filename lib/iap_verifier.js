...
(function() {
  ...
  IAPVerifier = (function() {
    ...
    function IAPVerifier(password, production, preencoded, debug) {
      this.password = password;
      this.production = production != null ? production : true;
      this.preencoded = preencoded != null ? preencoded : false;
      this.debug = debug != null ? debug : false;
      this.host = this.production ? this.productionHost : this.sandboxHost;
      this.port = 443;
      this.path = '/verifyReceipt';
      this.method = 'POST';
      this.preencodedReceipt = this.preencoded;
    }
